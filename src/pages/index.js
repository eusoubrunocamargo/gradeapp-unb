    ...
    <>
      ...
      <main className={styles.mainContainer}>
        ...
        <section className={styles.leftContainer}>  
            <svg viewBox="0 0 566 414" fill="red" xmlns="http://www.w3.org/2000/svg" className={styles.logogradeplus}>
            ...
            <p className={styles.p1}>Acesse sua conta agora mesmo:</p>  
            <button className={styles.Entrarbutton} onClick={() => router.push('/signup')}>Entrar</button>
        </section>
        ...
        <section className={styles.rightContainer}>
            ...
            <form 
                ...
                <p className={styles.p2}>Cadastre-se para acessar</p>
                </div>

                <NameInput newCheckForm={newCheckForm} setNewCheckForm={setNewCheckForm}/>
                <EmailInput newCheckForm={newCheckForm} setNewCheckForm={setNewCheckForm}/>
